...
- [KilasOS](https://kilasos.org) - Open-source edge NAS operating system. Single Go binary, OpenZFS storage, Docker apps, SMB/NFS shares. Zero cloud dependency. ([Source Code](https://github.com/kilasos/kilasos)) `GPL-3.0` `Go`
